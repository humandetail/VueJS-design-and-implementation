...
![最长递增子序列](E:\www\笔记\VueJS-design-and-implementation\imgs\快速diff\15.png)

因为 source 数组的最长子序列为 `[2, 3]`，其中，元素 2 在该数组中的索引为 0，而元素 3 在该数组中的索引为 1，所以最终结果为 `[0, 1]`。

有了最长递增子序列的索引信息后，下一步要重新对节点进行编号，如下图所示：

![重新对节点进行编号](E:\www\笔记\VueJS-design-and-implementation\imgs\快速diff\16.png)
...
![简化后的图](E:\www\笔记\VueJS-design-and-implementation\imgs\快速diff\17.png)
...
![节点以及索引的当前状态](E:\www\笔记\VueJS-design-and-implementation\imgs\快速diff\18.png)
...
![节点以及索引的当前状态](E:\www\笔记\VueJS-design-and-implementation\imgs\快速diff\19.png)
...
![节点以及索引的当前状态](E:\www\笔记\VueJS-design-and-implementation\imgs\快速diff\20.png)
